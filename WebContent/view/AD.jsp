...
<body>
	...
	<div id="box">
		<ul>
			...
			<li class="img-li"><img src="image/1.jpg"></li>
			<li class="img-li"><img src="image/2.jpg"></li>
			<li class="img-li"><img src="image/3.jpg"></li>
			<li class="img-li"><img src="image/4.jpg"></li>
		</ul>
...
/*对图片下方的四个小圆点按钮对象进行获取操作*/	
	...
	/*next.onclick是指当点击next标签对象当中的元素时将会触发的事件函数*/
 	next.οnclick=function nextClick()
	{
		img_index++;
	...
	previous.οnclick=function previousClick()
	{
		img_index--;
		if(img_index<0)
...
停止操作*/
	...
	one.οnmοuseοver=one.onclick;
	/*点击第二个小圆点时触发的方法*/
	two.οnclick=function twoClick()
	{
		oldLi.style.opacity=0;
		newLi=imgli[1];
		newLi.style.opacity=1;
	...
	two.οnmοuseοver=two.onclick;
	
	/*点击第三个小圆点触发方法来进行图片的显示*/
	three.οnclick=function threeClick()
	{
		oldLi.style.opacity=0;
		newLi=imgli[2];
		newLi.style.opacity=1;
	...
	three.οnmοuseοver=three.onclick;
	
	/*点击第四个小圆点来进行对应事件的触发操作*/
	four.οnclick=function fourClick()
	{
		oldLi.style.opacity=0;
		newLi=imgli[3];
		newLi.style.opacity=1;
